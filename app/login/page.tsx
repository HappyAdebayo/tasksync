    ...
    <main className="flex min-h-screen items-center justify-center bg-[#F9FAFB] px-4">
      <div className="w-full max-w-[400px]">
        <div className="mb-7 flex flex-col items-center gap-2.5">
          ...
          <h1 className="text-[19px] font-semibold text-[#101828]">Welcome back</h1>
          <p className="text-[13px] text-[#667085]">Log in to keep things moving.</p>
        </div>
        ...
        >
          ...
          <div className="mb-2">
            <div className="mb-1.5 flex items-center justify-between">
              <label htmlFor="password" className="block text-[12.5px] font-medium text-[#101828]">
                Password
              </label>
